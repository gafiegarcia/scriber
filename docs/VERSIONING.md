...
Current native status: `0.7.0` build `3`, frozen as the first personal-use alpha snapshot.
...
- Keep the native Xcode marketing version at `0.7.0` and bundle build at `3` until the next intentionally distinguishable build.

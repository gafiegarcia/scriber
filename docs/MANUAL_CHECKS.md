...
- Unplug or switch off the selected input device, then press the shortcut. **Dictation failed** appears as a box with no Retry and no See History, carrying whatever macOS said. Read it, and check History has no row for the attempt. A Bluetooth headset powered off is the easiest way in; selecting a device in Settings ▸ Sound and then disconnecting it is the deliberate one. Spends no credit — nothing is sent. Spec: Delivery and floating pill — "A notice never offers a recovery it cannot perform"

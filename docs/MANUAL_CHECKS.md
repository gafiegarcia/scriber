...
- With Wi-Fi off, dictate, stop, and press Escape while the pill counts down to another attempt. **No further attempt is made** — no third pill appears — whether the offer is then dismissed with Escape, taken away by **See History**, or left to time out on its own. The row settles and stops changing.

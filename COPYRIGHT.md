...
Except where a file or component states otherwise, original Scriber source code and documentation in this repository are licensed under the GNU General Public License as published by the Free Software Foundation, either version 3 of the License or, at the recipient's option, any later version (`GPL-3.0-or-later`). See [`LICENSE`](LICENSE) for the full terms.

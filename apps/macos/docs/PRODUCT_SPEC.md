...
- Show Cancel on the pill's leading edge in every recording mode; add Confirm on its trailing edge only while hands-free. Converting a held recording to hands-free widens the existing pill and animates only Confirm into it. Cancel uses the normal recording-cancellation path and Confirm stops and transcribes.

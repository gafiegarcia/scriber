...
import { TranscribeOptionsProvider } from "@/lib/transcribe-options-context";
import { DictionaryProvider } from "@/lib/dictionary-context";
import { KeyStatusProvider } from "@/lib/key-status-context";
import { BottomTabBar } from "@/components/bottom-tab-bar";
import { DesktopSidebar } from "@/components/desktop-sidebar";
import { FirstRunModal } from "@/components/first-run-modal";
import { KeyStatusBanner } from "@/components/key-status-banner";
...
export const metadata: Metadata = {
  title: "Scriber",
  description: "Local-first voice transcription with your own API key",
};
            ...
            <TranscribeOptionsProvider>
              <DictionaryProvider>
                ...
                <div className="flex h-dvh flex-col overflow-hidden bg-background">
                  <a
                    href="#main-content"
                    className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:bg-background focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-foreground focus:outline-2 focus:outline-foreground"
                  >
                    Skip to content
                  </a>
                  <div
                  ...
                  <div className="flex min-h-0 flex-1">
                    ...
                    <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
                      ...
                      <ServerStatusBanner />
                      <KeyStatusBanner />
                      <main id="main-content" className="flex-1 overflow-y-auto overscroll-y-contain lg:overflow-hidden">
                        {children}
                      </main>
                      <BottomTabBar />
                    </div>

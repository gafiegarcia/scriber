...
- **The short pills are 12 points narrower.** Recording, **Transcribing…**, **Copied** and **Canceled** all sat on one shared minimum width that had not been revisited since the word "Recording" was taken off the recording pill, so most of them carried empty space between their text and whatever sat on the right. The level meter is unchanged in the one state where it is smallest — both Cancel and Confirm showing — and is wider than before everywhere else.

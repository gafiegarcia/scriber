...
- **The short pills are 22 points narrower.** Recording, **Transcribing…**, **Copied** and **Canceled** all sat on one shared minimum width that had not been revisited since the word "Recording" was taken off the recording pill, so most of them carried empty space between their text and whatever sat on the right. The level meter absorbs the change while a dictation runs, and gives up 6 of its 22 bars only in the one state where both Cancel and Confirm are showing.
